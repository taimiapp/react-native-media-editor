...
import { calculateCurrentTime, formatTime } from './helpers';
import { isAndroid, isIOS } from '../../../../core/Helpers';
import { TCropperRef } from '../../../MediaCropper/MediaCropper';
import { TCropResult } from '../../../MediaCropper/interfaces';
import { RootReducer } from '../../../../redux/reducers';
import { selectFunnelSetting } from '../../../../redux/selectors/utils/funnelSelectors';
...
export const useVideoEditorState = ({
  ...
  const boomerangDurationMs = useSelector((state: RootReducer) =>
    selectFunnelSetting(state, 'boomerangDuration')
  );
